 ...
 *	third_party.thread state.  This third_party.thread state is examined with the thread_get_state
...
/*
 *	The actual structure that comprises the third_party.thread state is defined
...
/*
 *	Generic definition for machine-dependent third_party.thread status.
 */
